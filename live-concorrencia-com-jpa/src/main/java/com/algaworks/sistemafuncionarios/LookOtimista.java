...
public class LookOtimista {
    ...
    public static class TelaDeFuncionarios {
        ...
        public TelaDeFuncionarios(String sessao, EntityManagerFactory entityManagerFactory, Funcionario funcionario, String novoNome) {
            this.sessao = sessao;
        ...
        public void editarNome() { funcionario.setNome(novoNome); }

        public void submeterFormulario() {
            System.out.println(sessao + ": Iniciando tentativo de atualizar funcionário.");
