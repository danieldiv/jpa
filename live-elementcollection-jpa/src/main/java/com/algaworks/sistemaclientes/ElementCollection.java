...
public class ElementCollection {
    ...
    public static void main(String[] args) {
        ...
        //cliente.setEnderecos(Arrays.asList("Rua Parana, 10, Bairro Brasil - Belo Horizonte/MG"));
        //cliente.setEnderecos(Arrays.asList(endereco));
        //cliente.setEnderecos(Collections.singletonMap("casa", "rua Sao Paulo, 5000, Brasil - Belo Horizonte/MG"));
